...
export const mockBorrowers: (AssessmentInput & { id: string })[] = [
  {
    ...
    upi: { monthlyTransactions: 95, avgTransactionAmount: 1200, lateNightTransactions: 8, gamblingAppUsage: false, cryptoTransactions: false, p2pLendingUsage: false },
  ...
  },
  {
    ...
    upi: { monthlyTransactions: 210, avgTransactionAmount: 800, lateNightTransactions: 28, gamblingAppUsage: true, cryptoTransactions: false, p2pLendingUsage: true },
  ...
  },
  {
    ...
    upi: { monthlyTransactions: 45, avgTransactionAmount: 5500, lateNightTransactions: 5, gamblingAppUsage: false, cryptoTransactions: true, p2pLendingUsage: false },
  ...
  },
  {
    ...
    upi: { monthlyTransactions: 180, avgTransactionAmount: 450, lateNightTransactions: 35, gamblingAppUsage: false, cryptoTransactions: true, p2pLendingUsage: true },
  ...
  },
  {
    ...
    upi: { monthlyTransactions: 60, avgTransactionAmount: 900, lateNightTransactions: 3, gamblingAppUsage: false, cryptoTransactions: false, p2pLendingUsage: false },
...
export const defaultAssessmentInput: AssessmentInput = {
  ...
  upi: { monthlyTransactions: 80, avgTransactionAmount: 1000, lateNightTransactions: 10, gamblingAppUsage: false, cryptoTransactions: false, p2pLendingUsage: false },
  insurance: { hasLifeInsurance: false, hasHealthInsurance: false, hasLoanProtection: false, hasGuarantor: false, guarantorCreditScore: 0 },
};
